...
[Slack in the #racial-justice-general channel](https://developer.ibm.com/callforcode/racial-justice/get-started/). Minor issues can simply be addressed by sending by a pull request.
